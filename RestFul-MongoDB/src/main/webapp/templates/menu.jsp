...
<title>RestFul-MongoDB Application</title>
	...
	<div class="navbar navbar-inverse">
		<div class="container-fluid">
			<div class="navbar-header">
				<a class="navbar-brand" href="#">Aplicação RestFul com MongoDB</a>
			</div>
			<div>
				<ul class="nav navbar-nav">
					<li class="active" ><a href="jsp/consultarRegistros.jsp">Listar Pessoas</a></li>
				</ul>
			</div>
		</div>
	</div>
